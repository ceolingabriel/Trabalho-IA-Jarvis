...
| `AdvancementsinAI-BasedCompilerOptimization(...).pdf` | Advancements in AI-Based Compiler Optimization Techniques for Machine Learning Workloads | Artigo científico | Publicação acadêmica | Inglês; escopo restrito a otimização de compiladores para ML |
| `Information Systems Journal - 2025 - Pieper (...).pdf` | How AI Helps to Compile Human Intelligence: An Empirical Study of Emerging... | Artigo de journal | Information Systems Journal (2025) | Inglês; acesso via assinatura institucional |
